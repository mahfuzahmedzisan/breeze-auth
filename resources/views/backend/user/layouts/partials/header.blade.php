        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start">
                ...
                <a href="" class="flex ml-2 md:mr-24">
                    <img src="{{asset('backend/assets/images/logo.svg')}}" class="h-8 mr-3" alt="FlowBite Logo" />
                    <span
                ...
                <div class="z-20 z-50 hidden max-w-sm my-4 overflow-hidden text-base list-none bg-white divide-y divide-gray-100 rounded shadow-lg dark:divide-gray-600 dark:bg-gray-700"
                    ...
                    <div>
                        <a href="#"
                            ...
                            <div class="flex-shrink-0">
                                <img class="rounded-full w-11 h-11"
                                    src="{{asset('backend/assets/images/users/bonnie-green.png')}}" alt="Jese image">
                                <div
                        ...
                        <a href="#"
                            ...
                            <div class="flex-shrink-0">
                                <img class="rounded-full w-11 h-11"
                                    src="{{asset('backend/assets/images/users/jese-leos.png')}}" alt="Jese image">
                                <div
                        ...
                        <a href="#"
                            ...
                            <div class="flex-shrink-0">
                                <img class="rounded-full w-11 h-11"
                                    src="{{asset('backend/assets/images/users/joseph-mcfall.png')}}" alt="Joseph image">
                                <div
                        ...
                        <a href="#"
                            ...
                            <div class="flex-shrink-0">
                                <img class="rounded-full w-11 h-11"
                                    src="{{asset('backend/assets/images/users/leslie-livingston.png')}}"
                                    alt="Leslie image">
                                <div
                        ...
                        <a href="#" class="flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-600">
                            <div class="flex-shrink-0">
                                <img class="rounded-full w-11 h-11"
                                    src="{{asset('backend/assets/images/users/robert-brown.png" alt="Robert image')}}">
                                <div
